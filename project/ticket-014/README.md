...
- [ ] AC-03: `goal -a` publishes one exact ticket head and all required hosted
  FixOS checks pass for that head.
- [ ] AC-04: The deployed OneDev profile automatically reports
  `onedev/local-verify=PASS` and dispatches the same repository, PR, ticket and
  HEAD to Validator Agent.
- [ ] AC-05: The trusted Validator App approves and merges the exact head, and
