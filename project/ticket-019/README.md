...
Add interactive shell (REPL) and quick menu with TAB completion and command history for seamless user experience.
...
- [x] AC-05: Interactive shell (REPL) and quick menu with TAB completion implemented and tested.
